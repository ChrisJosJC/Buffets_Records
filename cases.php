...
<head>
	...
	<!--    SCRIPT JS    --->
	<script defer type="text/javascript" src="node_modules/froala-editor/js/froala_editor.pkgd.min.js"></script>
	<script defer src="<?php echo SERVERURL ?>js/script.js"></script>
...
<body >
		...
		<nav>
			<ul>
				<?php if ($_SESSION['id_tipo'] == 3) { ?>
					<!-- Secretaria: Ver todos los casos -->
	...
	<section class="operations">
		<input type="checkbox" name="btnaddCase" id="btnaddCase">
		<div class="operations-item">
			<label for="btnaddCase" title="Add Case">
			<i class="fas fa-plus-circle"></i>
			</label>
			<div class="inputAddCase">
				<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					<h3>Detail your case <label for="btnAddCase">❌</label></h3>
						<textarea name="desc" id="example" cols="30" rows="5" placeholder="Notes of the case"></textarea>
						<select 
						class="minimal" name="estado" id="estado">
					...
					<label for="cliente">
						<input type="text" name="cliente" placeholder="Nombre de tu cliente">
					</label>
					<input type="submit" value="Send Case" name="AddCase">
				</form>
			</div>
		</div>
		...
		<div class="operations-item">
			...
			<div class="inputAddFile">
				<form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					...
					<p class="title-login"><i class="fas fa-file"></i>Add case</p>		
					<input type="file" name="file" id="file" onchange="cambiar()" required>
					<label for="file" id="info">Select case</label><br>
